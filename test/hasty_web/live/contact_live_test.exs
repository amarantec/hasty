defmodule HastyWeb.ContactLiveTest do
  use HastyWeb.ConnCase

  import Phoenix.LiveViewTest
  import Hasty.ContactsFixtures

  @create_attrs %{ddi: "some ddi", ddd: "some ddd", phone_number: "some phone_number"}
