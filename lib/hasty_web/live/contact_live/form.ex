defmodule HastyWeb.ContactLive.Form do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      ...
      <.form for={@form} id="contact-form" phx-change="validate" phx-submit="save">
        <.input field={@form[:ddi]} type="text" label="DDI" />
        <.input field={@form[:ddd]} type="text" label="DDD" />
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:form, to_form(Contacts.change_contact(socket.assigns.current_scope, contact)))
  end
  ...
  def handle_event("validate", %{"contact" => contact_params}, socket) do
    changeset = Contacts.change_contact(socket.assigns.current_scope, socket.assigns.contact, contact_params)
  ...
  defp save_contact(socket, :edit, contact_params) do
    case Contacts.update_contact(socket.assigns.current_scope, socket.assigns.contact, contact_params) do
      {:ok, contact} ->
        {:noreply,
         socket
